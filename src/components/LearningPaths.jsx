...
const LearningPaths = () => {
  ...
  return (
    <div className="learning-paths-section py-20 bg-gradient-to-b-slate">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="path-meta flex justify-between text-xs text-slate-500 dark:text-slate-400 mt-4 pt-4 border-t border-slate-200-30 dark-border-slate-700-30">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs bg-gradient-to-r ${path.color.includes('cyan') ? 'bg-gradient-to-r-from-cyan-500-to-blue-500-10 text-cyan-500' : path.color.includes('purple') ? 'bg-gradient-to-r-from-purple-500-to-pink-500-10 text-purple-500' : path.color.includes('blue') ? 'bg-gradient-to-r-from-blue-500-to-cyan-500-10 text-blue-500' : 'bg-gradient-to-r-from-green-500-to-teal-500-10 text-green-500'}`}>
                    {path.level}
                  </span>
                </div>
              </div>

              <div className="absolute inset-0 bg-gradient-to-br from-cyan-500-0 bg-transparent to-blue-500-0 group-hover-from-cyan-500-5 group-hover-to-blue-500-5 transition-all duration-500 pointer-events-none"></div>
            </div>
          ))}
        </div>
