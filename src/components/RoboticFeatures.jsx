...
const RoboticFeatures = () => {
  const features = [
    {
      icon: (
        <div className="robotic-feature-icon robotic-feature-icon-cyan">
          <svg className="robotic-feature-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      icon: (
        <div className="robotic-feature-icon robotic-feature-icon-purple">
          <svg className="robotic-feature-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      icon: (
        <div className="robotic-feature-icon robotic-feature-icon-green">
          <svg className="robotic-feature-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      icon: (
        <div className="robotic-feature-icon robotic-feature-icon-orange">
          <svg className="robotic-feature-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      icon: (
        <div className="robotic-feature-icon robotic-feature-icon-blue">
          <svg className="robotic-feature-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      icon: (
        <div className="robotic-feature-icon robotic-feature-icon-pink">
          <svg className="robotic-feature-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="robotic-features-section">
      <div className="robotic-features-container">
        <div className="robotic-features-header">
          <h2 className="robotic-features-title">
            Core <span style={{background: 'linear-gradient(135deg, var(--futuristic-cyan), var(--neon-purple))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Robotic</span> Concepts
          </h2>
          <p className="robotic-features-subtitle">
            Master the fundamental technologies that power next-generation humanoid robots
          </p>
        </div>

        <div className="robotic-features-grid">
          {features.map((feature, index) => (
            <div
              key={index}
              className="robotic-feature-card group relative"
            >
              <div className="mb-6">
                {feature.icon}
              </div>
              <h3 className="robotic-feature-title group-hover:text-cyan-400">
                {feature.title}
              </h3>
              <p className="robotic-feature-description">
                {feature.description}
              </p>

              {/* Hover effect element */}
              <div className="robotic-feature-hover-effect"></div>
            </div>
          ))}
        </div>
      </div>
